...
const config = {
  ...
  appDescription:
    "Get a deep dive into your dynasty football leagues with leage breakdowns, in depth team reviews and much more.",
  // REQUIRED (no https://, not trialing slash at the end, just the naked domain)
  domainName: "fantasynexus.us",
  crisp: {
