...
import { playerCard2 } from "@/assets";
...
export const SkeletonOne = () => {
  return (
    <div className="relative flex py-8 px-2 gap-10 h-full">
      ...
      <div className="absolute bottom-0 z-40 inset-x-0 h-60 bg-gradient-to-t from-base-200 dark:from-black via-base-200 dark:via-black to-transparent w-full pointer-events-none" />
      <div className="absolute top-0 z-40 inset-x-0 h-60 bg-gradient-to-b from-base-200 dark:from-black via-transparent to-transparent w-full pointer-events-none" />
    </div>
  );
};
